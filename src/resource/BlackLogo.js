  ...
  return (
    <SvgIcon {...props} viewBox="0 0 2953.1254 3312.5">
      <g transform="scale(15.625) translate(10, 10)">
        ...
        <g id="SvgjsG2556" featurekey="root" fill="#000" />
        <g
          id="SvgjsG2557"
          featurekey="symbol1"
          // fill="#000"
        ...
        >
          <path d="M28.539,12.634a1,1,0,0,0,.7,1.873,7.847,7.847,0,0,1,5.518,0,1,1,0,0,0,.7-1.873A9.866,9.866,0,0,0,28.539,12.634Z" />
          <path d="M37.979,10.47a1,1,0,0,0,.461-1.887,14,14,0,0,0-12.88,0,1,1,0,1,0,.92,1.775,12,12,0,0,1,11.04,0A1,1,0,0,0,37.979,10.47Z" />
          <path d="M23.729,6.315a15.892,15.892,0,0,1,16.542,0A1,1,0,0,0,41.309,4.6a17.9,17.9,0,0,0-18.618,0,1,1,0,0,0,1.038,1.711Z" />
          <path d="M16,41.31v19.7a1,1,0,0,0,1,1H47a1,1,0,0,0,1-1V41.31L32,26.766Zm18.133,1.008a1,1,0,0,1,1.366-.367,7,7,0,1,1-7,0,1,1,0,1,1,1,1.732,5,5,0,1,0,5,0A1,1,0,0,1,34.133,42.318ZM33,41.008v6a1,1,0,1,1-2,0v-6a1,1,0,0,1,2,0Z" />
          <path d="M56.018,37.788l-22-20a3,3,0,0,0-4.036,0l-22,20a3,3,0,1,0,4.036,4.439L32,24.062,51.982,42.227a3,3,0,1,0,4.036-4.439Z" />
        </g>
        <g
          id="SvgjsG2558"
          featurekey="text1"
